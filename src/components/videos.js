      ...
      <div style={{ display: 'flex' }}>
        <div style={{ flex: 1, flexDirection: 'column' }}>
          <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
            ...
            <img
              alt=""
              style={{ margin: 5, border: '3 solid #2D4571', backgroundColor: 'white' }}
            ...
            <img
              alt=""
              style={{ border: 3, backgroundColor: '#2D4571' }}
              width="150"
        ...
        <div style={{ flex: 4, margin: 100 }}>
          <ReactPlayer width="100%" heigh="auto" url={this.state.video} playing controls={true} />
        </div>
      </div>
    )
  }
